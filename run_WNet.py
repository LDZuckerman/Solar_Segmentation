...
WNet_name = 'WNet36nm'
n_classes = 3 #
channels = ['X'] # ['X', 'Bz']# ['timeseries40_5'] # ['X', 'Bz'] # ['timeseries20_5'] # ['timeseries40_9'] # ['X', 'power2', 'binary_residual'] 
weights = [1] #[1, 4] # weight channels differently in the rec loss (mse loss)
